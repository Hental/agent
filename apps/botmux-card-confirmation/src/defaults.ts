import type { CardOption, Target } from './types.js';

// Verified Mini private-chat mapping. Callers must verify the current Botmux session.
export const DEFAULT_TARGET: Readonly<Target> = Object.freeze({
...
export const DEFAULT_OPTIONS: readonly CardOption[] = Object.freeze([
